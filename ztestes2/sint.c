...
{
       0,   103,   103,   105,   106,   109,   116,   125,   128,   131,
     135,   136,   143,   144,   145,   148,   157,   170,   171,   172,
     175,   177,   180,   181,   184,   186,   189,   193,   196,   200,
     204,   205,   206,   210,   211,   214,   215,   220,   223,   226,
     229,   233,   235,   236,   239,   243,   250,   255,   260,   265,
     270,   275,   280,   285,   290,   294,   301,   309,   312,   313,
     314
};
#endif
...
#line 109 "bison.y"
    { (yyval.dec)=inicializadec(); 
			...
			tbl=adicionaVar(tbl,(yyvsp[(1) - (1)].decvar).p_listnom,(yyvsp[(1) - (1)].decvar).tip); 
			verificasimbolos(tbl,(yyvsp[(1) - (1)].decvar).p_listnom);
			imprimirlista(tbl);
			}
    break;
...
#line 116 "bison.y"
    {  (yyval.dec)=inicializadec(); 
		...
		//	tbl=adicionaFunc(tbl,$1); 
			verificasimbolo(tbl,(yyvsp[(1) - (1)].decfunc).id);
			imprimirlista(tbl);
}
    break;
...
#line 148 "bison.y"
    {(yyval.decfunc)=inicializadecfunc((yyvsp[(2) - (6)].id), (yyvsp[(4) - (6)].pars), (yyvsp[(6) - (6)].bloco)); 
						...
						tbl=adicionaFunc(tbl,(yyval.decfunc),(yyvsp[(4) - (6)].pars));  
